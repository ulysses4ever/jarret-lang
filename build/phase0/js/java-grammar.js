...
R(['fs', 'jglr/jglr'], function(fs, E) {
  ...
  g.addRule("prim-expr", [new Token("PARENSPACE"), new Nonterm("binop-expr"), new Token("RPAREN")])
  g.addRule("prim-expr", [new Token("PARENAFTERBRACE"), new Nonterm("binop-expr"), new Token("RPAREN")])
